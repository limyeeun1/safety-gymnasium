...
class Actor(nn.Module):
    def __init__(self, n_states, n_actions, n_goals, n_hidden1=256, n_hidden2=256, n_hidden3=256, initial_w=3e-3):
        ...
        # init.xavier_normal_(self.fc1.weight,gain=2)
        # init.xavier_normal_(self.fc2.weight, gain=2)
        # init.xavier_normal_(self.fc3.weight)
        # init.xavier_normal_(self.output.weight)

        # init.uniform_(self.fc1.weight, -self.initial_w, self.initial_w)
        # init.uniform_(self.fc2.weight, -self.initial_w, self.initial_w)
        # init.uniform_(self.fc3.weight, -self.initial_w, self.initial_w)
        # init.uniform_(self.output.weight, -self.initial_w, self.initial_w)

        # init.normal_(self.fc1.weight, 0,0.1)
        # init.normal_(self.fc2.weight, 0,0.1)
        # init.normal_(self.fc3.weight, 0,0.1)
        # init.normal_(self.output.weight, 0,0.1)
...
class Critic(nn.Module):
    def __init__(self, n_states, n_goals, n_hidden1=256, n_hidden2=256, n_hidden3=256, initial_w=3e-3, action_size=1):
        ...
        # init.normal_(self.fc1.weight, 0, 0.2)
        # init.normal_(self.fc2.weight, 0, 0.2)
        # init.normal_(self.fc3.weight, 0, 0.2)
        # init.normal_(self.output.weight, 0, 0.1)
